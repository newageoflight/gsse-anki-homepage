...
<div id="downloads">
    ...
    <ol>
        ...
        <li><DownloadRow link="#" status="prerelease">Abdomen (86% complete)</DownloadRow></li>
        <li><DownloadRow link="#" status="nonrelease">Head, neck and spine (61% complete)</DownloadRow></li>
