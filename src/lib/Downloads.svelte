...
<div id="downloads">
    ...
    <h2>In parts</h2>
    <ol>
        <li><DownloadRow link="#" status="public">Introduction to regional anatomy (50% complete)</DownloadRow></li>
        ...
        <li><DownloadRow link="#" status="public">Thorax</DownloadRow></li>
        <li><DownloadRow link="#" status="public">Abdomen (50% complete)</DownloadRow></li>
